...
public class ItemController {
    ...
    @PostMapping
    public ResponseEntity<Item> addItem(@RequestHeader("X-Sharer-User-Id") Integer userId,
    ...
    @GetMapping
    public ResponseEntity<Collection<Item>> getAllItems(@RequestHeader("X-Sharer-User-Id") Integer userId) {
